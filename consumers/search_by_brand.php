...
$header_brand = '';
$file = "../img/brands/banners/".$brand."_".$lang.".png";
$md5  = filemtime($file);
...
<br>
<div>
    <div class="w-100 mb-0 text-center carousel_header"><?php echo $vtxt['search_by_brand'] ?> : <?php echo $wbrands[$brand]['name']; ?> </div>
...
<div class="" style="margin-left:3vw;margin-right:3vw;">
    <div class="w-100 grid">
        ...
        $jsonsrch = file_get_contents('https://dashfga.com/prdsearch_brand.php?brand='.$brand.'&node=1');
