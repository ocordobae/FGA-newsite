...
<head>
    ...
    <link href="../css/testimonial_columns_carousel.css" rel="stylesheet" media="all">
...
<div>
    <div class="w-100 mb-0 text-center carousel_header">SEARCH RESULTS : </div>
    <div class="w-100 m-0 text-center carousel_header_sub">XOXOXOXXXOXO XOX XOXOXOXO</div>
...
<div class="" style="margin-left:3vw;margin-right:3vw;">
    <div class="w-100 grid">
        ...
        $jsonsrch = file_get_contents("https://dashfga.com/prdsearch.php?tx={$urlsearch}&sku=&node=1&lang={$lang}");
...
<?php /* echo "https://dashfga.com/prdsearch.php?tx={$urlsearch}&sku=&node=1&lang={$lang}";  */  ?>
